...
public class DBService
{
    ...
    /**************INCLUIDO*****************/
    public int myExecuteNonQuery(string sQuery, CommandType ctType, OracleParameter[] colParameters, ref string status)
    {
        try
        {
            if (!ConectarOracle(false))
    ...
    public int getDataTableFromQuery(string sQuery, ref DataTable dt)
    {
        try
        {
            if (!ConectarOracle(false))
